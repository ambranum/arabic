...
//
// WHICH pictures is the pack's, not this file's. The band and the skyline that used to live here
// were a Palestinian cross-stitch and the Dome of the Rock -- as language-specific as any word in
// the lexicon, and the one thing app.js is not supposed to contain. They are in ar.js now, beside
// the section banners they belong with, and he.js answers the same two keys with its own.
