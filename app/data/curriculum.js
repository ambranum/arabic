...
window.CURRICULUM = {
  ...
  activities: {
    ...
    recall:   {label:'Recall drill',              slot:'break',   order:3, speak:false, builds:'Production from memory',
               instr:'Fill a verb paradigm from memory, or match words to meanings. Say each answer out loud before you type or tap it.'},
