...
import split  # noqa: E402  -- index/bodies layout
_sizes = split.write_verbs(data)
# len(top) misses the four hand-added verbs inserted above (it read 3000 while shipping 3003).
print('\n-> %s  (%d verbs)' % (os.path.relpath(paths.data('verbs.js'), ROOT), len(data['verbs'])))
print('   index %d KB + %d paradigm files' % (_sizes['verbs.js'] // 1024, _sizes['_chunks']))
